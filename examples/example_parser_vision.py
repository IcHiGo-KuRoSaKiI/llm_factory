...
class MockLogger:
    def log_success(self, file_path, schema_name, weaviate_uuid, operation_type):
        print(
            f"SUCCESS: {operation_type} operation on {file_path} successful.")
    ...
    **client_kwargs
    ...
    try:
        ...
        client = LLMClientFactory.create_client(
            client_type=client_type, **client_kwargs)
...
def process_document(
    ...
    **client_kwargs
    ...
    try:
        ...
        print(
            f"Processing {filename} using {client_type} for image extraction...")
...
if __name__ == "__main__":
    ...
    azure_result = process_document(
        file_path=r"Solution Architecture Final.pptx",
        client_type="azure",
