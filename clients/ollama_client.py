...
class OllamaLLMClient(BaseLLMClient):
    ...
    def __init__(self,
        ...
        try:
            ...
            self.client = ollama.Client(
                host=host_url or os.getenv("OLLAMA_HOST_URL")
            )
    ...
    def generate_completion(self,
        ...
        while attempts < max_attempts:
            try:
                ...
                # Call the ollama API
                response = self.client.chat(**completion_params)
    ...
    def get_openai_response_image(self, 
        ...
        Note: Ollama doesn't support vision features natively, so we use OpenAI as a fallback
        ...
        try:
            ...
            logger.info("Using OpenAI client for image processing (Ollama doesn't support vision)")
