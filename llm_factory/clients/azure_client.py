...
class AzureLLMClient(BaseLLMClient):
    ...
    def __init__(self,
        ...
        try:
            ...
            self.default_top_p = default_top_p or float(os.getenv("AZURE_TOP_P", "1.0"))
            self.default_top_k = default_top_k or int(os.getenv("AZURE_TOP_K", "0"))
            self.default_frequency_penalty = default_frequency_penalty or float(os.getenv("AZURE_FREQUENCY_PENALTY", "0.0"))
            self.default_presence_penalty = default_presence_penalty or float(os.getenv("AZURE_PRESENCE_PENALTY", "0.0"))
            self.default_repetition_penalty = default_repetition_penalty or float(os.getenv("AZURE_REPETITION_PENALTY", "1.0"))
            self.default_min_p = default_min_p or float(os.getenv("AZURE_MIN_P", "0.0"))
            self.default_top_a = default_top_a or float(os.getenv("AZURE_TOP_A", "0.0"))
            self.default_seed = default_seed or (int(os.getenv("AZURE_SEED")) if os.getenv("AZURE_SEED") else None)
